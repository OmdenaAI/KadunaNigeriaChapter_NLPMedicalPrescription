...
if __name__ == "__main__":
    main()def visualize_real_results(results, output_dir):
    """
    ...
    for model in models:
        ...
        if failed:
            print(f"  Failed cases: {', '.join(failed)}")def visualize_results(results, output_dir):
    """
    ...
    for model in models:
        ...
        print(f"  Average Processing Time: {results[model]['avg_time'] * 1000:.1f} ms")#!/usr/bin/env python3
"""
...
from dev.agentic_model import AgenticMedicalModel  
